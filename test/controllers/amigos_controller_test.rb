...
class AmigosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amigo" do
    assert_difference('Amigo.count') do
      post amigos_url, params: { amigo: { email: @amigo.email, first_name: @amigo.first_name, last_name: @amigo.last_name, phone: @amigo.phone, twitter: @amigo.twitter } }
    end
  ...
  test "should update amigo" do
    patch amigo_url(@amigo), params: { amigo: { email: @amigo.email, first_name: @amigo.first_name, last_name: @amigo.last_name, phone: @amigo.phone, twitter: @amigo.twitter } }
